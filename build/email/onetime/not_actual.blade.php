<table width="100%" style="min-height: 500px;" border="0" cellspacing="0" cellpadding="20" background="http://l-contract.uran.tk/assets/img/bg.png">
    <tr style="vertical-align: top; text-align: center;">
        <td>
            ...
            <h3 style="font-family: Arial, sans-serif;">Contest not actual</h3>
            <p style="font-family: Arial, sans-serif; color: #505050; font-size: 14px;">Sadly to say, but customer (company <a style="font-family: Arial, sans-serif; color: #e31a27; text-decoration: underline;" href="_CUSTOMER_URL"><b>_CUSTOMER_NAME</b></a>) with concurs for <b>_CARGO_DESCRIPTION</b> delivery from dates <b>_LOADING_DATES_FROM - _LOADING_DATES_TILL</b> (loading place: <b>_LOADING_COUNTRY, _LOADING_CITY</b>) till dates <b>_DELIVERY_DATES_FROM - _DELIVERY_DATES_TILL</b> (delivery place: <b>_DELIVERY_COUNTRY, _DELIVERY_CITY</b>) has closed or finished the contest.<br/><br/>Try to win another contest.</p>
            <a style="font-family: Arial, sans-serif; color: #e31a27; text-decoration: underline;" href="{{ route('profile') }}">Click here to view latest concurses</a>
        </td>
    </tr>
...
{{ route('profile') }} - change to route - onetime concurs list
-->